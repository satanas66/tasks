...
public class Execute1 {
    ...
    private static Logger LOG = Logger.getLogger(Execute1.class);
    ...
    public static void main(String[] arg) {
        ...
        mercadoPotencial.generateFileListsToExecution(5);
    ...
    private static void execution(MercadoPotencial mercadoPotencial) {
        if (mercadoPotencial.isContinuaProceso()) {
            List<List<Integer>> clientCodes = mercadoPotencial.getClientCodes("clientCodes1.txt");
    ...
    private static void setUp(MercadoPotencial mercadoPotencial, List<List<Integer>> clientCodes) {
        ...
        for (int i = 0; i < clientCodes.size(); i++) {
            MercadoPotencialThread hilo = new MercadoPotencialThread(" Hilo1");
            hilo.instancePatameters("C:/tasks/mercado-potencial-mongo/src/main/resources/", "MERCADO_POTENCIAL_1.xlsx");
