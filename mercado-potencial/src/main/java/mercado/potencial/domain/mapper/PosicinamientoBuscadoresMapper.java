...
import mercado.potencial.domain.business.PosicionamientoBuscadores;

/**
 * @author Edwin Patricio Arévalo Angulo
 *
 * Clase que permite la conversión de la proyección PosicinamientoBuscadores en una entidad de negocio
 */
