...
public class ExecuteMercadoPotencial {
    ...
    public static void execution(int threadNumber, MercadoPotencial mercadoPotencial) {
    ...
    public static void setUp(MercadoPotencial mercadoPotencial, List<List<Integer>> clientCodes) {
