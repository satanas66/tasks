...
//    @Test
    public void findAllClientCodes() {
        List<Integer> result = f_datos_contactoProjection.findAllClientCodes();
    ...
    public void getProjectionFromF_Datos_ContactoToMuestraMadreByClientCode() {
        Object[] result = f_datos_contactoProjection.getProjectionFromF_Datos_ContactoToMuestraMadreByClientCode(199493321);
        assertThat(result).isNotNull();
        assertThat(result.length).isNotZero().isEqualTo(14);
    }
}