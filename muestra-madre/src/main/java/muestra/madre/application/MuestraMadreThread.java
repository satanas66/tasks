...
import muestra.madre.domain.business.*;
import muestra.madre.domain.mapper.*;
 ...
 */
public class MuestraMadreThread extends Thread {

    private static Logger LOG = Logger.getLogger(MuestraMadreThread.class);
    ...
    public MuestraMadreThread(String nombreHilo) {
        super(nombreHilo);
    }
